...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/cadenacorazonhuecoplaa.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Cadena de corazón</h1><br>
            <p class="price"><strong>Lps. 350 <span></span></strong></p><br>
