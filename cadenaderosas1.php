...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/cadenaderosas1.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Gargantilla de rosas</h1><br>
            <p class="price"><strong>Lps. 470 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 35 cm de largo.</p><br>
            <p><strong>Color de rosas disponibles:</strong> Rojo, Negro, Azul, Rosa, Café, Blanco, Verde y Morado.</p><br>
