...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collarcolgantecorazon1.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar de corazón</h1><br>
            <p class="price"><strong>Lps. 450 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 35 cm, 40 cm y 43 cm de largo</p><br>
