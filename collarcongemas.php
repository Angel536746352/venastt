...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collarcongemas.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar con Gemas</h1><br>
            <p class="price"><strong>Lps. 430 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 40cm, 45 cm y 50 cm de largo</p><br>
            <p><strong>Colores de la gema disponibles:</strong> Blanco, Negro, Verde, Rojo, Naranja y Azul</p><br>
            <p><strong>Colores de perlas disponibles:</strong> Blanco y Dorado</p><br>
          ...
          <a href="https://wa.me/message/CK64WY2BYBR6L1" class="wishlist">¡Comprar Ahora!</a>
            <a href="collaresf.php" class="wishlist">Volver</a>

            <p class="shipping">*Hacemos envíos a nivel nacional 🚚📦</p>
            <p class="brand">Joyería y Bisutería Rashti 👑</p>
        </div>
    </section>
