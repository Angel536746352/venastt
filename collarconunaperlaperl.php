...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collarconunaperlaperl.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar de perlas</h1><br>
            <p class="price"><strong>Lps. 250 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 30cm, 40cm, 45cm, 50cm y 60cm de largo</p><br>
          ...
          <a href="https://wa.me/message/CK64WY2BYBR6L1" class="wishlist">¡Comprar Ahora!</a>
            <a href="collaresf2.php" class="wishlist">Volver</a>
